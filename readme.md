...
## Overview: 
          The system utilizes a mutual-monitoring "ping-pong" architecture where
...
## Goals: 
       The primary objective is to provide high availability and fault tolerance,
...
## Usage:
       Developers integrate the system by calling WDStart with specified tolerance and interval parameters.
...
## compiling and running:
        The user file and watchdog_file needs to be in the same folder.
